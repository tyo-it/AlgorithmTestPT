...
class StoreTest {
    ...
    @Test
    fun `store array with a map that has one entry`() {
    ...
    @Test
    fun `store array with a map that has one entry with empty key`() {
    ...
    @Test
    fun `store array with a map that has one entry with empty value`() {
    ...
    @Test
    fun `store array with a map that has one entry with empty key and value`() {
    ...
    @Test
    fun `store array with a map that has two entry`() {
    ...
    @Test
    fun `store array with two map, each has one entry`() {
